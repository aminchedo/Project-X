...
const defaultFlags: Record<string, FeatureFlag> = {
  ...
  // Project-X integration features
  'market-intel': {
    id: 'market-intel',
    name: 'Market Intelligence',
    description: 'Enable market intelligence dashboard with sentiment, news, and whale tracking',
    enabled: true,
    category: 'analytics',
    rolloutPercentage: 100,
  },
  'settings-panel': {
    id: 'settings-panel',
    name: 'Settings Panel',
    description: 'Enable settings and configuration management panel',
    enabled: true,
    category: 'functionality',
    rolloutPercentage: 100,
  },
  'backtesting-module': {
    ...
    name: 'Backtesting Module',
    description: 'Enable advanced backtesting suite for strategy validation',
    enabled: false,
    category: 'trading',
    rolloutPercentage: 25,
    dependencies: ['portfolio-management'],
